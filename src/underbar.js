(function() {
  ...
  _.last = function(array, n) {
    return n === undefined ? array[array.length - 1] : array.length-n > 0 ? array.slice(array.length - n,array.length) : array;
  };
  ...
  _.filter = function(collection, test) {
    ...
    _.each(collection, function(item, index) {
        if (test(item)) retArray.push(item);
    });
    return retArray;
  };
  ...
  _.uniq = function(array) {
    var retArray = [];
    _.each(array, function(item,index){ if(_.indexOf(array,item) === index) retArray.push(item); });
    return retArray;
  };
  ...
  _.map = function(collection, iterator) {
    ...
    var retArray = [];
    _.each(collection, function(item){ retArray.push(iterator(item)) });
    return retArray;
  };
  ...
  _.extend = function(obj) {
    for (var i = 1; i < arguments.length; i++){
        _.each(arguments[i],function(val,key){obj[key] = val});
    }
    return obj;
  };
  ...
  _.shuffle = function(array) {
    ...
    for (var i = 0; i < array.length; i++){
      ...
      retArray.push(arrCopy[randIndex]);
